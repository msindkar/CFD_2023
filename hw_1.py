...
# Homework 1
# Code assumes odd number of evenly spaced points
# Code assumes that left of the middle point is subsonic, middle point is sonic and right of middle point is supersonic
# Inputs:
# p0 - Stagnation pressure, K (float)
# t0 - Stagnation temperature, Pa (float)
# A  - area of at corresponding x-coordinates, m2 (list) (odd number of points, 5 points)
# A_star - area at throat, middle value of A array (float) (derived)

def supersonic_nozzle(p0, t0, A):
...
sol = supersonic_nozzle(300000, 600, [1, 0.6, 0.2, 0.6, 1])